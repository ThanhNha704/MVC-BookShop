...
class CheckoutController extends BaseController
{
    ...
    public function place_order()
    {
        ...
        // 1. Lấy và Validate thông tin giao hàng
        $delivery = [
        ...
        // 2. LẤY DỮ LIỆU TỔNG TIỀN VÀ SẢN PHẨM TỪ FORM POST
        ...
        if (!$orderId) {
            $_SESSION['error'] = 'Không thể tạo đơn hàng. Vui lòng thử lại.' . $orderItems;
            return $this->redirect('?controller=checkout');
        }
