<footer class="bg-gray-800 text-white mt-10 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-5 break-words">
            <div>
            ...
            <div>
                ...
                <p class="text-base text-gray-400">
                    ...
                    <a href="mailto:baobang21032004@gmail.com" class="hover:text-white">
                        <span>baobang21032004@gmail.com</span>
                    </a>
                </p>
            </div>
        </div>
