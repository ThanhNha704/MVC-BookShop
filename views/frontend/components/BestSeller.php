...
<section class="mb-12 max-w-[95%] mx-auto">
    ...
    <?php if (!empty($bestSellers)): ?>
        ...
        <div
            class="product-list grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 p-3 my-3">
            ...
            foreach ($bestSellers as $books =>$value) {
                ...
                ?>
                <a href="?controller=product&action=details&id=<?= $value['id'] ?>" class="relative transition ease-in-out duration-300 hover:shadow-2xl shadow-lg h-full 
                    flex flex-col justify-between bg-stone-50 p-3 rounded-lg border border-gray-100"
                    ...
                    <div class="overflow-hidden flex flex-col justify-start items-center py-2 px-1">
                        ...
                        <p class="font-sans py-2 text-md font-semibold text-gray-800 h-12 line-clamp-2 text-center">
                        ...
                        <div class="font-sans grid grid-rows-2 gap-1 py-2 w-full mt-auto">
                            ...
                            if (($value['discount'] ?? 0) != 0) {
                                ...
                                rounded-full text-white bg-red-600 px-3 py-1 text-sm font-bold right-0 top-0">
                                    <?= '-' . $value['discount'] . '%'; ?>
                                </p>
                                <?php
                            }
