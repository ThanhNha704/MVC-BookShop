...
<main class="w-[90%] mx-auto py-8">
    ...
    <section class="mb-12 py-12 px-6 rounded-xl shadow-xl bg-white">
        <div class="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div class="space-y-5">
                ...
                <a href="?controller=product" 
                   class="inline-block px-7 py-2.5 bg-amber-500 text-white text-lg font-semibold 
            ...
            <div class="flex justify-center md:justify-end">
                <img src="./public/products/banner_sach.jpg" 
                      alt="Banner Sách Bookaza" 
