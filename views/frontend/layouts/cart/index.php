...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="max-w-[90%] mx-auto bg-white rounded-lg shadow-lg p-6">
                    ...
                    <thead class="bg-gray-100">
                        <tr>
                            <th class="px-6 py-4 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">Sản
                                phẩm</th>
                            <th class="px-6 py-4 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">Giá
                            </th>
                            <th class="px-6 py-4 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">Số
                                lượng</th>
                            <th class="px-6 py-4 text-right text-sm font-bold text-gray-700 uppercase tracking-wider">Tạm
                                tính</th>
                        ...
                        <?php foreach ($items as $item): ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-6 flex items-center gap-4">
                                    ...
                                    <div>
                                        <div class="text-lg font-semibold text-gray-900"><?= htmlspecialchars($item['title']) ?>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-6">
                                    <form action="?controller=cart&action=update" method="POST" class="flex items-center">
                                        ...
                                        <div
                                            class="flex items-center gap-1 bg-gray-50 rounded-lg border border-gray-300 p-1 mr-2">
                                ...
                                <td class="px-6 py-6 text-right text-lg font-bold text-gray-900">
                                ...
                                <td class="px-6 py-6 text-right">
                                    <form action="?controller=cart&action=remove" method="POST">
                                        <input type="hidden" name="product_id"
                                            value="<?= htmlspecialchars($item['product_id']) ?>">
                                        <button type="submit"
                                            class="text-red-600 text-base font-medium hover:text-red-700">Xóa</button>
                                    </form>
                                </td>
                            </tr>
                        <?php endforeach; ?>
            ...
            <div class="mt-6 flex justify-between items-center">
                ...
                <div class="text-right space-y-2">
                    ...
                    <a href="?controller=checkout"
                        class="mt-2 inline-block bg-amber-600 text-white px-4 py-2 rounded hover:bg-amber-700">
