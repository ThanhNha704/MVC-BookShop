...
<div class="flex-1 bg-gray-50 p-8 overflow-scroll">
    <div class="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-lg">
        <h1 class="text-3xl font-extrabold mb-2 text-gray-900">Sửa Sản phẩm: #<?= htmlspecialchars($product['id']) ?></h1>
        <p class="text-gray-500 mb-6">Chỉnh sửa thông tin chi tiết cho cuốn sách "<?= htmlspecialchars($product['title']) ?>".</p>
        ...
        <form action="?controller=admin&action=updateProduct" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="author" id="author"
                       value="<?= htmlspecialchars($product['author']) ?>"
                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-amber-500 focus:ring-amber-500">
            </div>
