...
?>
<h2 class="text-2xl font-bold mb-6 text-gray-800">Quản lý Voucher & Khuyến mãi Sản phẩm</h2>

<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    
    <div class="bg-white p-6 rounded-xl shadow-lg">
        <h3 class="text-xl font-semibold mb-4">Danh sách Voucher (Số lượng, Thời hạn)</h3>
        <a href="#" class="mb-4 inline-block px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 transition-colors">+ Thêm Voucher</a>
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg">
        ...
        <button class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 transition-colors">Tạo Khuyến mãi Sản phẩm</button>
    </div>
</div>